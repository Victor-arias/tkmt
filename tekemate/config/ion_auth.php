...
*/
	...
	$config['tables']['meta']    = 'Meta_usuarios';
	
	/**
	 * Site Title, example.com
	 */
	$config['site_title']		   = "Tekemate";
	
	/**
	 * Admin Email, admin@example.com
	 */
	$config['admin_email']		   = "hugovic1182@gmail.com";
	
	/**
	 * Default group, use name
	 */
	$config['default_group']       = 'administradores';
	
	/**
	 * Default administrators group, use name
	 */
	$config['admin_group']         = 'administradores';
	 
	/**
	 * Meta table column you want to join WITH.
	 * Joins from users.id
	 **/
	$config['join']                = 'Id_usuario';
	
	/**
	 * Columns in your meta table,
	 * id not required.
	 **/
	$config['columns']             = array('Nombre', 'Apellido');
     ...
     * Default : auth/
	 **/
	$config['email_templates']     = 'administracion/usuario/email/';
